...
//games
import { Tower } from "./cloud-jump";
import { Frogger } from "./frogger/index";
import { Balance } from "./balance/index";
import { Catcher } from './catcher/index';
import { Twofold } from './twofold/index';
...
export class App extends Application {
	...
	constructor(parent: HTMLElement) {
		...
		this.games = { Pong,  Maze, Twofold ,Catcher, Balance, Tower, Frogger };
		this.lang = 'en_US';
	...
	load() {
		...
		this.lang =  data.data["lang"] || this.lang;
